...
const img_n2 = slide_img.length; //목록개수
console.log(img_n2);
const img_w2 = 1900;  //이미지 한장 너비
const m2 =0; //마진 값
const s_con2 = 1; //보여줄 개수

let count2 = 0;

function mslide2(n){
  slide2.style.left =-(img_w2+m2)*n+'px';
  count2 = n;
  console.log(slide2.style.left);
}


const Timer2 = setInterval(function(){
  if(count2 < img_n2 - s_con2){
    mslide2(count2+1)
  }else{
    mslide2(0);
  }
